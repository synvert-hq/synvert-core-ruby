  ...
  module Engine
    class Slim
      class << self
        ...
        #         state = :ruby_expression
        #       elsif char == ' '
        #         state = :possible_ruby_expression_or_plain_text
        #       end
        #       encoded_source << ' '
        #     when :possible_ruby_expression_or_plain_text
        #       if char == '='
        #         state = :ruby_expression
        #       else
        #         state = :plain
        ...
        #     when :plain
        #       if char == '#'
        #         state = :possible_string_interpolation
        #       end
        #       encoded_source << ' '
        #     when :possible_string_interpolation
        #       if char == '{'
